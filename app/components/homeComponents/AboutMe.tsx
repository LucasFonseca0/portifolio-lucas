    ...
    <section className="relative">
      ...
      <div className="pt-[11vh] sm:pl-[15%] relative flex flex-col sm:flex-row text-black items-center ">
        ...
        <TranslateAnimation.TranslateLeft>
          <div className=" m-auto z-10  w-[80%] mt-6 sm:mt-0 font-semibold text-base md:text-sm sm:text-xs lg:text-lg 2xl:text-2xl text-center sm:text-start sm:w-[40%] sm:ml-[10%]">
