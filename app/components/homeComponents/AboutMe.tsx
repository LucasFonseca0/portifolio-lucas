...
const responsiveAboutMeBackground = "h-16 w-40 sm:h-20 sm:w-48 md:h-24 md:w-64 lg:h-28 lg:w-72 xl:h-30 xl:w-80 2xl:h-32 2xl:w-96";
const responsiveAboutMeText = "text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl";
...
const Dots = () => (
  <div className="grid grid-rows-2 grid-flow-col gap-2 md:gap-3 lg:gap-4 absolute right-[15%] md:right-[15%] bottom-[-4%] sm:bottom-[-6%] md:bottom-[-7%] lg:bottom-[-13%] xl:bottom-[-6%] xl:right-[17%] 2xl:right-[25%]">
    {[...Array(2)].map((_, rowIndex) => (
      <div key={rowIndex} className="flex gap-3 md:gap-4 lg:gap-6">
  ...
  return (
    <section className="relative">
      <div className="w-full h-[11vh] relative bg-primary rounded-ee-[100px]">
        <h2 className={`absolute top-[100%] ${responsiveAboutMeBackground} ${responsiveAboutMeText} -translate-y-1/2 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-[15%] rounded-b-[60px] rounded-t-[20px] bg-black flex justify-center items-center text-primaryDarkest font-bold`}>
      ...
      <Image
        ...
        width={77}
        height={77}
        className="absolute right-0 z-0 w-10 top-[14%] sm:w-12 md:w-16 sm:top-[18%] xl:w-20 xl:top-[20%]"
      />
