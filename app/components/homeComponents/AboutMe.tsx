  ...
  return (
    <section className="">
      ...
      <Image
          ...
          width={77}
          height={77}
          className={" absolute right-0 z-0 -top-50  "}
        ></Image>
      <div className="pt-[11vh] sm:pl-[15%] relative flex flex-col sm:flex-row text-black items-center ">
        <Image
          ...
          width={427}
          height={427}
          className={"z-10 w-[75%] sm:w-48 md:w-64 lg:w-72 xl:w-80 2xl:w-96"}
        ></Image>
        <p className="[&>span]:text-secondary z-10  w-[80%] mt-6 sm:mt-0 font-bold text-base md:text-sm sm:text-xs lg:text-lg 2xl:text-xl sm:w-[30%] sm:ml-[10%]">
          Sou um desenvolvedor <span>Fullstack</span> com especialização em <span>NextJs</span> no
          frontend e <span>NestJs</span> no backend. Utilizo Tailwind CSS para garantir
          interfaces elegantes e Docker para ambientes consistentes.
          <br />
          <br />
          Minha experiência abrange bancos de dados <span>SQL</span> e <span>NoSQL</span>, utilizando ORMs
          como Mongoose e Prisma. Sou proficiente em <span><span className="text-primaryDarkest">Git</span></span> e GitHub para controle
          de versão colaborativo.
        </p>
      </div>
    </section>
  );
