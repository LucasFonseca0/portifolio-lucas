    ...
    resources: {
      en: {
        translation: {
          ...
          "review_1": "Precise, analytical, proactive. These are the three steps of Lucas's work methodology. He uses available resources and those he doesn't have to develop solutions and never leaves any project hanging. Efficient, intelligent, and collaborative, this is the professional Lucas is.",
          "review_2": "Lucas is a very hardworking and talented developer. He navigates through challenges, quickly learns new technologies, and adapts to new teams, stacks, and projects. He is an excellent addition to any team and has proven his skills in diverse projects using various languages and working in all areas (front-end, back-end, and databases). I am confident that his profile suits perfectly any software engineer opportunities that may arise.",
          ...
          "leo_souza": "@Leo Souza - Frontend developer",
          "review_leo": "Precise, analytical, proactive. These are the three steps of Lucas's work methodology. He uses available resources and those he doesn't have to develop solutions and never leaves any project hanging. Efficient, intelligent, and collaborative, this is the professional Lucas is.",
          "mozart_soares": "@Mozart Soares - Fullstack developer",
          "review_mozart": "Lucas is a very hardworking and talented developer. He navigates through challenges, quickly learns new technologies, and adapts to new teams, stacks, and projects. He is an excellent addition to any team and has proven his skills in diverse projects using various languages and working in all areas (front-end, back-end, and databases). I am confident that his profile suits perfectly any software engineer opportunities that may arise.",
          "calvin_soares": "@Calvin Soares - Fullstack developer",
          "review_calvin": "Lucas is a very hardworking person, always creating programming content, always helping in any way he can. He is a good person and an even better professional."
        },
      },
      pt: {
        translation: {
          ...
          "review_1": "Preciso, analítico, proativo. Esses são os três passos da metodologia de trabalho do Lucas. Ele usa os recursos disponíveis e os que não tem para desenvolver soluções e nunca deixa nenhum projeto pendente. Eficiente, inteligente e colaborativo, esse é o profissional que Lucas é.",
          "review_2": "Lucas é um desenvolvedor muito trabalhador e talentoso. Ele navega pelos desafios, aprende rapidamente novas tecnologias e se adapta a novas equipes, stacks e projetos. Ele é uma excelente adição a qualquer equipe e provou suas habilidades em projetos diversos, usando várias linguagens e trabalhando em todas as áreas (front-end, back-end e bancos de dados). Estou confiante de que seu perfil se encaixa perfeitamente em qualquer oportunidade de engenheiro de software que possa surgir.",
          "hotelHopper_title": "HotelHopper",
          ...
          "leo_souza": "@Leo Souza - Desenvolvedor Frontend",
          "review_leo": "Preciso, analisa, faz. Esses são os três passos da metodologia de trabalho do Lucas, usa os recursos que tem e os que não tem para desenvolver soluções e nunca deixa nenhum projeto na mão. Eficiente, inteligente e coletivo, esse é o profissional que Lucas é.",
          "mozart_soares": "@Mozart Soares - Desenvolvedor Fullstack",
          "review_mozart": "Lucas é um desenvolvedor muito trabalhador e talentoso, ele trabalha superando qualquer desafio e é capaz de aprender rapidamente novas tecnologias e se adaptar a novas equipes, stacks e projetos. Ele é uma excelente adição a qualquer equipe e provou suas habilidades em projetos diversos, usando várias linguagens e trabalhando em todas as áreas (front-end, back-end e bancos de dados). Estou confiante de que seu perfil se encaixa perfeitamente em qualquer oportunidade de engenheiro de software que possa surgir.",
          "calvin_soares": "@Calvin Soares - Desenvolvedor Fullstack",
          "review_calvin": "Lucas é uma pessoa muito esforçada, sempre criando conteúdo de programação, sempre ajudando da forma que pode. É uma boa pessoa e um profissional melhor ainda."
        },
      },
    },
    lng: 'en',
